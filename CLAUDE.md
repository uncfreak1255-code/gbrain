...
When `git merge origin/master` reports conflicts on release metadata, resolve
in this exact order:
...
6. **Run the 5-line audit above.** If it doesn't show your version on
   all five lines, you missed a marker.
