...
- **Context around a date:** `gbrain query "conversation" --since 2025-03-15 --until 2025-03-15 --limit 20`
  finds dated archive pages; `gbrain recall --since 2025-03-15 --grep "X"`
  checks the extracted-facts arm.
